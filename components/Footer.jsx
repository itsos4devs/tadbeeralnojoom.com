  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mt-20">
        ...
        {/* Icons */}
        {/* https://www.facebook.com/Alnujoom.workers */}
        {/* https://www.instagram.com/tadbeer__al_nujoom/ */}
        {/* https://twitter.com/alworkers?s=11&t=v6HA9uIz68m-mdH1Yq_yXw */}
        <div className="flex md:space-x-5 space-x-2 items-center">
          {/* insta in */}
          <div
            className="bg-[#234F7E]/25 md:p-2 p-1 rounded-full text-[#234F7E] cursor-pointer"
            onClick={() => {
              window.open(
                "https://www.instagram.com/tadbeer__al_nujoom/",
                "_blank"
          ...
          <div
            className="bg-[#234F7E]/25 md:p-2 p-1 rounded-full text-[#234F7E] cursor-pointer"
            onClick={() => {
              window.open("https://www.youtube.com/@tadbeeralnujoom", "_blank");
            }}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
